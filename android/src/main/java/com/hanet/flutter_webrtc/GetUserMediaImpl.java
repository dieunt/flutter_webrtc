...
import com.hanet.flutter_webrtc.record.AudioSamplesInterceptor;
import com.hanet.flutter_webrtc.record.MediaRecorderImpl;
import com.hanet.flutter_webrtc.record.OutputAudioSamplesInterceptor;
...
import com.hanet.flutter_webrtc.utils.MediaConstraintsUtils;
...
class GetUserMediaImpl {
    ...
    private AudioTrack getUserAudio(ConstraintsMap constraints) {
         Log.e(TAG, "getUserMedia(audio): -----" + constraints);
        ...
        if (constraints.getType("audio") == ObjectType.Boolean) {
            ...
            //audioConstraints.optional.add(new MediaConstraints.KeyValuePair("googEchoCancellation2", "false"));
            //audioConstraints.optional.add(new MediaConstraints.KeyValuePair("googDAEchoCancellation", "false"));
            //audioConstraints.mandatory.add(new MediaConstraints.KeyValuePair("googNoAudioProcessing", "true"));
        ...
        Log.e(TAG, "getUserMedia(audio): " + audioConstraints);
    ...
    void startRecordingToFile(
            String path,Integer mode, Integer id, @Nullable VideoTrack videoTrack,@Nullable AudioTrack audioTrack, @Nullable AudioChannel audioChannel)
            throws Exception {
        ...
        MediaRecorderImpl mediaRecorder = new MediaRecorderImpl(mode,id, videoTrack, audioTrack,interceptor);
