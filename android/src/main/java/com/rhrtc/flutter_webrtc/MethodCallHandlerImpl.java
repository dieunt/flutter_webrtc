package com.hanet.flutter_webrtc;

import static com.hanet.flutter_webrtc.utils.MediaConstraintsUtils.parseMediaConstraints;
...
import com.hanet.flutter_webrtc.record.AudioChannel;
import com.hanet.flutter_webrtc.record.FrameCapturer;
import com.hanet.flutter_webrtc.utils.AnyThreadResult;
import com.hanet.flutter_webrtc.utils.Callback;
import com.hanet.flutter_webrtc.utils.ConstraintsArray;
import com.hanet.flutter_webrtc.utils.ConstraintsMap;
import com.hanet.flutter_webrtc.utils.EglUtils;
import com.hanet.flutter_webrtc.utils.ObjectType;
import com.hanet.flutter_webrtc.utils.PermissionUtils;
...
public class MethodCallHandlerImpl implements MethodCallHandler, StateProvider {
  ...
  private Activity activity;
   ...
   private boolean audioManagerStarted;
   private int saveaudioSpeeked = 0;
   private boolean peerConnectionaudioManagerInit;
  ...
  MethodCallHandlerImpl(Context context, BinaryMessenger messenger, TextureRegistry textureRegistry,
    ...
    this.audioManagerStarted = false;
    this.peerConnectionaudioManagerInit = false;
  }
  ...
  private void ensureInitialized() {
    ...
    audioDeviceModule.setMicrophoneDefault(true);
    audioDeviceModule.setSpeekMuteDefault(true);
    audioDeviceModule.setMicrophoneEnable(false);
    audioDeviceModule.setSpeakerEnable(false);
...
/* 
  ...
  public void onMethodCall(MethodCall call, @NonNull Result notSafeResult) {
    ...
    switch (call.method) {
      ...
      case "StopAudioMode": {
        ...
        boolean getspeekres = audioDeviceModule.getSpeakerMute();
        if(!getspeekres){
               saveaudioSpeeked = 1;
               // audioDeviceModule.StopSpeaker();
        }
      ...
      case "StartAudioMode": {
           ...
           if(saveaudioSpeeked ==1){
               //audioDeviceModule.StartSpeaker();
               saveaudioSpeeked = 0;
           }
           result.success(null);
            break;
      ...
      case "setSpeekMute":
        boolean spmute = call.argument("mute");
        audioDeviceModule.setSpeakerMute(spmute);
        result.success(null);
        break;
      case "StartSpeek":
          if(!audioManagerStarted){
                  createRTCAudioManager();
          }
        audioDeviceModule.StartSpeaker();
        result.success(null);
        break;
       case "StopSpeaker":
        ...
        result.success(null);
        break;
      case "getSpeakerEnable":
         boolean gres = audioDeviceModule.getSpeakerEnable();
         result.success(gres);
        break;
      ...
      case "enableSpeakerphone":
        ...
        break;
      case "getSpeakerMute":
        boolean speekres = audioDeviceModule.getSpeakerMute();
        result.success(speekres);
       break;
       case "getMicrophoneMute":
       boolean micres = audioDeviceModule.getMicrophoneMute();
       result.success(micres);
      break; 
      case "getMicrophoneEnable":
         boolean res = audioDeviceModule.getMicrophoneEnable();
         result.success(res);
        break;
      case "setMicrophoneEnable":
        boolean enablem = call.argument("enable");
        audioDeviceModule.setMicrophoneEnable(enablem);
        result.success(null);
        break;
       case "StartMicrophone":
        ...
        audioDeviceModule.StartMicrophone();
        result.success(null);
        break;
      case "StopMicrophone":
        audioDeviceModule.StopMicrophone();
        result.success(null);
        break;
      ...
      case "startRecordToFile":
        ...
        try {
         ...
         if (call.hasArgument("mode")
                  && call.argument("mode") != null) {
                 mode = call.argument("mode");
          }
          Integer recorderId = call.argument("recorderId");
          if (videoTrack != null || audioChannel != null) {
            getUserMediaImpl.startRecordingToFile(path,mode,recorderId, videoTrack, audiorack,audioChannel);
            result.success(null);
          } else {
  ...
  public void createRTCAudioManager(){
if (Build.VERSION.SDK_INT < Build.VERSION_CODES.S
  ...
  public String peerConnectionInit(ConstraintsMap configuration, ConstraintsMap constraints) {
    ...
    if (mPeerConnectionObservers.size() == 0) {
              if(peerConnectionaudioManagerInit){
                    createRTCAudioManager();
              }
  ...
  private MediaConstraints defaultConstraints() {
    ...
    constraints.mandatory.add(new KeyValuePair("iceRestart", "true"));
  ...
  public void peerConnectionDispose(final String id) {
    // Log.d(TAG, "peerConnectionDispose() peerConnection id"+id);
    PeerConnectionObserver pco = mPeerConnectionObservers.get(id);
    if (pco == null || pco.getPeerConnection() == null) {
  ...
  public void addTransceiverOfType(String peerConnectionId, String mediaType, Map<String, Object> transceiverInit,
    ...
    if (pco == null || pco.getPeerConnection() == null) {
      resultError("addTransceiverOfType", "peerConnection is null", result);
       ...
       Log.e(TAG, "addTransceiverOfType() >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>  "+mediaType);
