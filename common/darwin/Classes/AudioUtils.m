...
+ (void)ensureAudioSessionWithRecording:(BOOL)recording {
  ...
  RTCAudioSessionConfiguration *config = [RTCAudioSessionConfiguration webRTCConfiguration];
    config.isSpeekMute = TRUE;  //default audio speek is mute ,you can set yourself
  config.isMicrophoneMute = TRUE;  //default audio Microphone is mute ,you can set yourself as you need.
