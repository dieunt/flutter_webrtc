...
abstract class RTCPeerConnection {
 ...
 Future<void> setSpeakerMute(bool mute);
 Future<void> setMicrophoneMute(bool mute);
 Future<bool> getSpeakerMute();
 Future<bool> getMicrophoneMute();
 Future<void> StartSpeek();
 Future<void> StopSpeek();
 Future<bool> getSpeakerEnable();
 Future<void> StartAudioMode();
 Future<void> StopAudioMode();

 Future<bool> getMicrophoneEnable();
 Future<void> setMicrophoneEnable(bool enable);
