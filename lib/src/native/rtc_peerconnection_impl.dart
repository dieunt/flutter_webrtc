...
class RTCPeerConnectionNative extends RTCPeerConnection {
  ...
  @override
 Future<void> setSpeakerMute(bool mute)async {
     await WebRTC.invokeMethod(
            'setSpeekMute',
            <String, dynamic>{'peerConnectionId': _peerConnectionId, 'mute': mute},
          );
 ...
 Future<void> StartSpeek()async{
    ...
    @override
 Future<void> StopSpeek()async{
     await WebRTC.invokeMethod(
            'StopSpeaker',
            <String, dynamic>{'peerConnectionId': _peerConnectionId},
          );
 }
  Future<void> StartAudioMode()async{
         await WebRTC.invokeMethod(
            'StartAudioMode',
            <String, dynamic>{'peerConnectionId': _peerConnectionId},
          );
  }
 Future<void> StopAudioMode()async{
       await WebRTC.invokeMethod(
            'StopAudioMode',
            <String, dynamic>{'peerConnectionId': _peerConnectionId},
          );
 ...
 @override
  Future<bool> getMicrophoneEnable() => WebRTC.invokeMethod(
        'getMicrophoneEnable',
        <String, dynamic>{'peerConnectionId': _peerConnectionId},
      ).then((value) => value ?? false);
  @override
   Future<void>  setMicrophoneEnable(bool enable) async {

          await WebRTC.invokeMethod(
            'setMicrophoneEnable',
            <String, dynamic>{'peerConnectionId': _peerConnectionId, 'enable': enable},
          );
   ...
   @override
 Future<bool> getSpeakerMute()=> WebRTC.invokeMethod(
        'getSpeakerMute',
        <String, dynamic>{'peerConnectionId': _peerConnectionId},
      ).then((value) => value ?? false);
  @override
 Future<bool> getMicrophoneMute()=> WebRTC.invokeMethod(
        'getMicrophoneMute',
        <String, dynamic>{'peerConnectionId': _peerConnectionId},
      ).then((value) => value ?? false);
 @override
  Future<bool> getSpeakerEnable() => WebRTC.invokeMethod(
        'getSpeakerEnable',
        <String, dynamic>{'peerConnectionId': _peerConnectionId},
      ).then((value) => value ?? false);
  @override
